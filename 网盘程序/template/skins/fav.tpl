                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue sbold uppercase">我的收藏 &nbsp;</span>
                                            <span class="caption-helper"> （你总共收藏了 <?=$this->csdb->get_nums('fav',array('uid'=>$user->id))?> 部视频） </span>
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                        <div class="tabbable-line">
                                            <ul class="nav nav-tabs">
                                                <li<?php if($cid == 0) echo ' class="active"';?>><a href="<?=links('fav')?>">全部视频</a></li>
                                                <?php 
